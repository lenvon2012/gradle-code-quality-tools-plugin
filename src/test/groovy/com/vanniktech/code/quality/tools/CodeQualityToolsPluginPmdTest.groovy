...
class CodeQualityToolsPluginPmdTest extends CommonCodeQualityToolsTest {
  @Test void java() {
    assert addPmd(javaProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertPmd(javaProject)
  }

  @Test void javaLibrary() {
    assert addPmd(javaLibraryProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertPmd(javaLibraryProject)
  }
  ...
  @Test void kotlin() {
    ...
    assert addPmd(kotlinProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertPmd(kotlinProject)
  }

  @Test void androidApp() {
    assert addPmd(androidAppProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertPmd(androidAppProject)
  }

  @Test void androidLibrary() {
    assert addPmd(androidLibraryProject, rootProject, new CodeQualityToolsPluginExtensionForTests())
