...
class CodeQualityToolsPluginCheckstyleTest extends CommonCodeQualityToolsTest {
  @Test void java() {
    assert addCheckstyle(javaProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertCheckstyle(javaProject)
  }

  @Test void javaLibrary() {
    assert addCheckstyle(javaLibraryProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertCheckstyle(javaLibraryProject)
  }
  ...
  @Test void kotlin() {
    ...
    assert addCheckstyle(kotlinProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertCheckstyle(kotlinProject)
  }

  @Test void androidApp() {
    assert addCheckstyle(androidAppProject, rootProject, new CodeQualityToolsPluginExtensionForTests())

    assertCheckstyle(androidAppProject)
  }

  @Test void androidLibrary() {
    assert addCheckstyle(androidLibraryProject, rootProject, new CodeQualityToolsPluginExtensionForTests())
